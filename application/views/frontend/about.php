			...
			<div class="tab-content" id="myTabContent">
				...
				<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
					<div class="row made_life_text">
						<div class="col-lg-6">
							<div class="left_side_text">
								<h3>Tabungan Aqiqah <br />(Kemudahan dalam ber-Aqiqah)</h3>
								<h6>Apa itu Tabungan Aqiqah ?</h6>
				...
				<div class="tab-pane fade show active" id="contact" role="tabpanel" aria-labelledby="contact-tab">
					<div class="row made_life_text">
						<div class="col-lg-6">
							<div class="left_side_text">
								<h3>Layanan Nasi Kotak <br />(Nasi Kotak Premium)</h3>
								<h6>Apa yang kami sediakan ?</h6>
...
<section class="screen_area text-center p_120">
	<div class="container">
		<div class="main_title">
			<h2>Dalil Aqiqah</h2>
			<h3>
				<p>كُلُّ غُلَامٍ مُرْتَهَنٌ بِعَقِيقَتِهِ، تُذْبَحُ عَنْهُ يَوْمَ السَّابِعِ، وَيُحْلَقُ رَأْسُهُ، وَيُسَمَّى</p>
			</h3>
			<h5>
				<p>"Setiap bayi tergadai dengan aqiqahnya, disembelihkan (kambing) untuknya pada hari ke tujuh, dicukur dan diberi nama”</p>
			</h5>
