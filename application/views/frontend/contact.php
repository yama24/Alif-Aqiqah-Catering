                    ...
                    <div class="col-lg-3">
                        <div class="contact_info">
                            ...
                            <div class="info_item">
                                ...
                                <h6><a href="#">(+62) 813-9573-3034</a></h6>
                                <p>Senin - Jum'at, 9am to 6 pm</p>
                            </div>
                            <div class="info_item">
                                <i class="lnr lnr-envelope"></i>
                                <h6><a href="#">cateringalifaqiqah@gmail.com</a></h6>
                                <p>Email Alif Aqiqah</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-9">
